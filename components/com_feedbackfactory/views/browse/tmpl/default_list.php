...
<?php foreach ($this->feedbacks as $feedback): ?>
  <a class="feedback" rel=<?php echo $feedback->type;?> href="<?php echo JRoute::_('index.php?option=com_feedbackfactory&task=feedback&id=' . $feedback->id . '&Itemid=' . $this->Itemid); ?>"></a>
  <!--list of feedbacks -->
  <div class="votes">
  	<div class="left_img">
