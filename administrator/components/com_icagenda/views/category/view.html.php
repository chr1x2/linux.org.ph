...
class iCagendaViewCategory extends iCJView
{
	...
	protected function addToolbar()
	{
		...
		if(version_compare(JVERSION, '3.0', 'lt')) {
			...
			JToolBarHelper::title($isNew ? '&lt;div style="float:right"&gt; &lt;img src="../media/com_icagenda/images/iconicagenda36.png" alt="logo" /&gt; &lt;/div&gt; iCagenda &rarr; &lt;i class="icon-new small"&gt; &lt;/i&gt;&lt;span style="font-size:14px;"&gt;' . JText::_('COM_ICAGENDA_LEGEND_NEW_CATEGORY') . '&lt;/span&gt;' : '&lt;div style="float:right"&gt; &lt;img src="../media/com_icagenda/images/iconicagenda36.png" alt="logo" /&gt; &lt;/div&gt; iCagenda &rarr; &lt;i class="icon-brush small"&gt; &lt;/i&gt;&lt;span style="font-size:14px;"&gt;' . JText::_('COM_ICAGENDA_LEGEND_EDIT_CATEGORY') . '&lt;/span&gt;');
		}
