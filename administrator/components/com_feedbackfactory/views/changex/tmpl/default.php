...
<style>
  .icon-48-image { background-image: url(<?php echo JURI::root(); ?>components/com_feedbackfactory/assets/images/image.png); }
</style>

<form action="index.php" method="POST" name="adminForm" id="adminForm">

  <?php echo JText::_('FEEDBACK_MOVE_SELECTED_TO'); ?>: <?php echo $this->categories; ?>
